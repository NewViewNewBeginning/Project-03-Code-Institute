...
def show_stock(stock, price):
    ...
    if answer == 'yes':
        print('\nAvaible stock:\n')
        print(f'CCTV SETS = {stock[0]} units which cost \U0001F4B5 ${price[0]} each')
        print(f'SAT-TV SETS = {stock[1]} units  which cost \U0001F4B5 ${price[1]} each')
    elif answer == 'no':
...
def complete_order(customer, data, total):
    ...
    print('Thank you for visisting and buying in our shop! \U0001F642 \U0001F642\n')
    data = data[0]
    paid = total[0]
